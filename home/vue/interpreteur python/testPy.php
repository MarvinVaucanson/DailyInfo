...
<head>
    ...
    <title>Interpréteur Python</title>
    <link rel="stylesheet" href="../css/login.css">
    <script src="https://code.jquery.com/jquery-3.6.4.min.js"></script>
    <script defer src="skulpt-dist-master/skulpt.min.js"></script>
    <script defer src="skulpt-dist-master/skulpt-stdlib.js"></script>
</head>
...
<body>
    ...
    <div class="DefiContainer">
        <h1>Interpréteur Python</h1>
        <h2>
            <?php echo isset($_SESSION['missiondujour']) ? $_SESSION['missiondujour']['description'] : ''; ?>
        </h2>
        <form id="pythonForm" action="" method="post">
            <textarea name="code" id="code" rows="10" cols="50"
                placeholder="Saisissez votre code Python ici"></textarea>
            <br>
        ...
        ?>
        <script defer src="interpreterPy.js"></script>
    </div>
</body>
